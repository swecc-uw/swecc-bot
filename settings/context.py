...
class BotContext:
    def __init__(self):
        ...
        self.badwords = ["ticket", "free.*macbook", "macbook.*free", "\$", "seat.*section", "help.*offer", "lumen field", "personal assistant", "run(ning)?.*errands", "free.*gift.*card","free.*visa","free.*paypal","work.*from.*home","earn.*money.*fast","crypto.*investment","make.*money.*online"]
